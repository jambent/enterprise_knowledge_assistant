...
def get_citation(question, answer, context):
    ...
    and determine from the provided context which source document the agent has used to obtain the answer.
    ...
    """
    context_list = [{"page_content": doc.page_content, "source": doc.metadata.get("source")} for doc in context]
    context_dict = {}
